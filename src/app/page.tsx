...
const PdfIcon = ({ onClick }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-filetype-pdf" viewBox="0 0 16 16" onClick={onClick} style={{ fontSize: '2rem', cursor: 'pointer' }}>
